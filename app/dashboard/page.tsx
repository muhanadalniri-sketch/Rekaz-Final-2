...
export default function Dashboard(){
  ...
  return (<div className='container' style={{display:'grid',gap:'1rem'}}>
    ...
    <div className='grid grid-3'>
      <div className='card'><h3 style={{marginTop:0}}>المكتمل عبر الزمن</h3><ChartCompletedOverTime data={bucketCompletedOverTime(records)} /></div>
      <div className='card'><h3 style={{marginTop:0}}>WO حسب الحالة</h3><ChartStatusBreakdown data={woStatusBreakdown(records)} /></div>
      <div className='card'><h3 style={{marginTop:0}}>توزيع مدد WNSC</h3><ChartWnscDurations data={wnscDurationHistogram(records)} /></div>
    </div>
    <h2>إضافة سجل</h2><RecordForm pref='OMAN_OIL' />
    <h2>السجلات</h2><RecordList />
  </div>)
}
